...
<head>
    ...
    <style>
        body {
            background: url("https://www.linkhr.ca/wp-content/uploads/revslider/main_slider/slider_2.jpg");
        }
    </style>
...
<div class="py-md-1" style="text-align: center;">
    <h1>Update Employee for ${departmentTitle} </h1>
</div>
...
<form class="needs-validation" method="post" novalidate>
    <div class="mx-auto" style="width: 400px;">
        ...
        <div class="form-group px-md-5">
            ...
            <input type="text" class="form-control" id="salaryPerHour" name="salaryPerHour" placeholder="${salaryPerHour}" required>
            <div class="invalid-feedback">This field is mandatory.</div>
        </div>

        <div class="form-group px-md-5">
            <label for="dateOfBirth">Date Of Birth</label>
            <input type="date" dataformatas="yyyy-MM-dd" class="form-control" id="dateOfBirth" name="dateOfBirth" placeholder=""${dateOfBirth}" required>
            <div class="invalid-feedback">This field is mandatory.</div>
        </div>
